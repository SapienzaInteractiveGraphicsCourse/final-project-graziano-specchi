...
function animateStick( stick ){
	let tween_stick = new TWEEN.Tween(stick.rotation).to({x: stick.rotation.x-Math.PI/3, y: stick.rotation.y, z:  stick.rotation.z-Math.PI/4}, 200);
